%% --------------------------提取源文件中的数据---------------------
function [vrp2e,coord_dep,coord_sat,coord_cus,fleet,timewindows,timeservice,demand,type,dis_ds,dis_sc,rad_ds,rad_sc,neib_ss,neib_cc,neib_sc,num_dep,num_sat,num_cus] = extractdata(set,seq)
    %----Name of Set2-Set4----
    %----total of Set2 is 30----
