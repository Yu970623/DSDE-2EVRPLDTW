...
%             re_dis_ds = 1./obj.data.dis_first;
%             re_dis_ds(isinf(re_dis_ds)) = 0;
%             re_dis_ds = re_dis_ds./max(max(re_dis_ds));
%             re_dis_sc = 1./obj.data.dis_second;
%             re_dis_sc(isinf(re_dis_sc)) = 0;
%             re_dis_sc = re_dis_sc./max(max(re_dis_sc));
%             obj.data.elite = [reshape(re_dis_ds, 1, []), reshape(re_dis_sc, 1, [])];
