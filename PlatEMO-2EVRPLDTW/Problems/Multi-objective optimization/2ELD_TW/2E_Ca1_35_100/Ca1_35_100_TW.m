classdef Ca1_35_100_TW < PROBLEM
    ...
    methods
        ...
        function Setting(obj)
            ...
            if isempty(obj.D); obj.D = 100; end %x_first+x_second
            obj.data.algorithm = [];
...
%             rng(noRng)
        ...
        function Population = Evaluation(obj,varargin)
            ...
            for i=1:N
                [PopObj(i,1),PopObj(i,2),PopCon(i,1),PopCon(i,2),PopCon(i,3),PopCon(i,4),PopCon(i,5),route{i}] = aimFcn0(PopDec(i,:),obj.option,obj.data);
            end
